...
enum parameters {ADJECTIVE_VELOCITY,DYNAMIC_VISCOSITY,DENSITY1,DENSITY2,EXTERNAL_FORCE,NIU};
...
class mesh{
    ...
    public:
        void setParameters(float u_bar,float nu, float rho1, float rho2, float f_x, float niu){
            parameters[ADJECTIVE_VELOCITY]=u_bar;
            parameters[DYNAMIC_VISCOSITY]=nu;
            parameters[DENSITY1]=rho1;
            parameters[DENSITY2]=rho2;
            parameters[EXTERNAL_FORCE]=f_x;
            parameters[NIU]=niu;
        }
